    ...
    SMLV          <- 1456910 
    ahno_valuacion<- 2024
    #tipo          <- "sin_desl_fch_corte"
    tipo          <- "sin_desl_cam_mesa_1" #"con_desl_cam_mesa"#
    #tipo          <- "con_desl_cam_mesa2_II_2024_" #"con_desl_cam_mesa2" #  
   ...
   base_formato_394 <- read_excel("data/FT394_ENE_2024 - cambio 12_SMMLV.xlsx" , sheet = "fecha_corte",
    ...
    #### ####
                                   col_types = c("text", "text", "text",
                                                 ...
                                                 "text", "text", "text",
                                                 "numeric", "numeric")
                                   ) #%>% mutate(NRO_MESADAS="13")
    #%>% filter(COMPANIA%in%c("ALFA","ALLIANZ") ) %>% mutate
   ...
   openxlsx::write.xlsx(dd, paste0("outputs/flujo_anual_pensiones",ahno_valuacion,"_",tipo,".xlsx"))
    #colnames(dd)
